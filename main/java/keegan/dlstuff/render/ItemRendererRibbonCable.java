...
public class ItemRendererRibbonCable implements IItemRenderer {

	protected ModelPlasmaPipe computerModel;
	protected ResourceLocation Tex;
	
	
	public ItemRendererRibbonCable()
	{
		computerModel = new ModelPlasmaPipe();
		Tex = new ResourceLocation("dlstuff:textures/blocks/DSCRibbonCable.png");
	}
