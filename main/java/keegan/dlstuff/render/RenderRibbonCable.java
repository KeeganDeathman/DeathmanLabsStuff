...
public class RenderRibbonCable extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler{

	public static Minecraft mc = Minecraft.getMinecraft();
	public static ModelPlasmaPipe model = new ModelPlasmaPipe();
	public static ResourceLocation tex = new ResourceLocation("dlstuff:textures/blocks/DSCRibbonCable.png");
	...
	public void renderPipe(TileEntityRibbonCable entity, double x, double y, double z, float tick)
	{
	 ...
	 public void configureSides(TileEntityRibbonCable tile)
	 {
		 int x = tile.xCoord;
	     int y = tile.yCoord;
	     int z = tile.zCoord;
	 ...
	 {
		 if(world.getTileEntity(x, y, z) instanceof TileEntityRibbonCable || world.getTileEntity(x, y, z) instanceof DSCPart)
			 return true;
		 return false;
	 }
	...
	{
		this.renderPipe((TileEntityRibbonCable) tileEntity, d, d1, d2, f);
	}
