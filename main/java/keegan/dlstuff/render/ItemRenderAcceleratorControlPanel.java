...
public class ItemRenderAcceleratorControlPanel implements IItemRenderer {
	...
	{
		computerModel = AdvancedModelLoader.loadModel(new ResourceLocation("dlstuff:models/acceleratorcontrolpanel.obj"));
		Tex = new ResourceLocation("dlstuff:textures/models/acceleratorcontrolpanel.png");
	}
