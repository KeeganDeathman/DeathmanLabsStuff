...
import keegan.dlstuff.tileentity.TileEntityAcceleratorDetectorCore;
...
public class RenderAcceleratorDetector extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler
{
	...
	public IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("dlstuff:models/accelleratordetector.obj"));
	...
	public void renderComputer(TileEntityAcceleratorDetectorCore entity, double x, double y, double z, float tick)
	{
	        ...
	        {
	        	// Binds the texture
			 	mc.renderEngine.bindTexture(new ResourceLocation("dlstuff:textures/models/acceleratorDetector.png"));
			 	GL11.glPushMatrix();
