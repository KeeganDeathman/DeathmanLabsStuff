...
public class ItemRenderDLLaptop implements IItemRenderer {

	protected ModelDLLaptop computerModel;
	protected ResourceLocation Tex;
	
	
	public ItemRenderDLLaptop()
	{
		computerModel = new ModelDLLaptop();
		Tex = new ResourceLocation("dlstuff:textures/models/BlockDLLaptop.png");
	}
	...
	private void renderEquipped(boolean inventory, ItemRenderType type,  Object... data)
    {
        ...
        if(inventory)
        {
        	...
        	computerModel.renderModel(0.03125F,false);
        }
        else if(!inventory)
        {
    		Minecraft.getMinecraft().renderEngine.bindTexture(Tex);
