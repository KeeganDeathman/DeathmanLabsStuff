...
public class RenderAcceleratorTube extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler{
	...
	public static ResourceLocation tex = new ResourceLocation("dlstuff:textures/models/acceleratorTube.png");
	...
	public void renderPipe(TileEntityAcceleratorTube entity, double x, double y, double z, float tick)
	{
	...
	{
		this.renderPipe((TileEntityAcceleratorTube) tileEntity, d, d1, d2, f);
	}
