...
public class GuiDLLaptop extends GuiContainer
{
			...
			if(usbControl)
			{
				switch(usbScreen)
				{
					case "main":
						...
						{
							System.out.println("Setting to plugin");
							usbScreen = "plugin";
						}
						else if(texX > 114 && texX < 146 && texY > 98 && texY < 118)
						{
							System.out.println("Setting to view");
							usbScreen = "view";
						}
						else if(texX > 154 && texX < 186 && texY > 98 && texY < 118)
						{
							System.out.println("Setting to unplug");
							usbScreen = "unplug";
						}
						break;
					case "plugin":
						...
						{
							usbScreen = "main";
							DLStuff.packetPipeline.sendToServer(new PacketDLLaptopUSB(tile.xCoord, tile.yCoord, tile.zCoord, Integer.parseInt(deviceUSB), ""));
					...
					case "unplug":
						...
						{
							usbScreen = "main";
							DLStuff.packetPipeline.sendToServer(new PacketDLLaptopUSB(tile.xCoord, tile.yCoord, tile.zCoord, 42, deviceUSB));
							this.deviceInput.setText("");
						}
						break;
					case "view":
			...
			if(internet)
			{
				...
				if(website.equals("downloads"))
				{
					...
					else if(texX > 113 && texX < 137 && texY > 99 && texY < 143)
					{
						...
						DLStuff.packetPipeline.sendToServer(new PacketDLLaptopWeb(tile.xCoord, tile.yCoord, tile.zCoord, "download-dPadOS"));
					}
				}
			}
		}
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
	{
		...
		if(usbControl)
		{
			...
			{
				case "main":
					this.mc.renderEngine.bindTexture(new ResourceLocation("dlstuff:textures/gui/laptop/usbcontrol.png"));
					break;
				case "plugin":	
					this.mc.renderEngine.bindTexture(new ResourceLocation("dlstuff:textures/gui/laptop/usbcontrolplugin.png"));
					break;
				case "view":
					this.mc.renderEngine.bindTexture(new ResourceLocation("dlstuff:textures/gui/laptop/usbcontrolview.png"));
					break;
				case "unplug":	
					this.mc.renderEngine.bindTexture(new ResourceLocation("dlstuff:textures/gui/laptop/usbcontrolunplug.png"));
			}
		...
		if(internet)
		{
			...
			{
				case "hub":
					this.mc.renderEngine.bindTexture(new ResourceLocation("dlstuff:textures/gui/laptop/internethub.png"));
					break;
				case "downloads":	
					this.mc.renderEngine.bindTexture(new ResourceLocation("dlstuff:textures/gui/laptop/internetdownloads.png"));
					break;
			}
	    	if(xSize == 512)
	    	{
